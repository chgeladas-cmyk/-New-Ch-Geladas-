...
(function () {
  ...
  const PERFIS_PADRAO = {
    colaborador: {
      ...
      modulos: { vendas:2, estoque:0, financeiro:0, fiado:2, cambio:0, comandas:0, delivery:0, ponto:1, cardapio:0, aprovacao_controle:0, aprovacao_validacao:0, relatorios:0 },
